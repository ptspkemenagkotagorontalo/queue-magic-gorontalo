    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto p-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-primary tracking-tight leading-tight mb-2">
            SISTEM ANTRIAN
          </h1>
          <h2 className="text-3xl font-bold text-primary tracking-tight leading-tight mb-2">
            KEMENTERIAN AGAMA
          </h2>
          <h3 className="text-2xl font-bold text-primary tracking-tight leading-tight mb-8">
            KOTA GORONTALO
          </h3>
        </div>
